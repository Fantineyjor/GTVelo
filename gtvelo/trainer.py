...
from gtvelo.utils import batch_func
...
def train_vae(model, adata, epochs = 50, learning_rate = 1e-5, batch_size = 200, grad_clip = 1, shuffle=True, test=0.1, name = '', optimizer='adam', random_seed=42):
